        ...
        <div className='subscribeComp'>
            <section className="text-gray-600 body-font bg-[url('../assets/Background.svg')] bg-no-repeat bg-cover min-h-[600px] h-full w-full">
                <div className="lg:container px-5 mx-auto py-[90px]">
                    <div className={"text-center sm:text-start w-full lg:w-[50%]"}>
                        <Image src={Logo} alt={"Logo"} width={166} height={168} />
                        <h1 className={"text-[32px] rtl:sm:text-end leading-[40px] sm:text-[48px] sm:leading-[56px] font-[700] text-[#1C2126] pt-[44px]"}>
                            {t("Abonnez-vous pour toute mise à jour")}
                        </h1>
                        <div className={"flex gap-1 justify-between h-[64px] mt-[32px] pl-0 bg-white border border-[#C0C5CE] rounded-[12px] w-full"}>
                        ...
                        <div className={'flex rtl:justify-end items-center mt-[48px] gap-[16px]'}>
