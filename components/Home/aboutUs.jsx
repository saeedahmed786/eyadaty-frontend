    ...
    return (
        <section className="text-gray-600 sm:bg-[url('../assets/Lines.png')] bg-cover bg-no-repeat  body-font aboutUsComp">
            <div className="container mx-auto flex px-3 sm:px-5 py-24 md:flex-row flex-col items-center justify-center ">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start justify-start text-end ltr:md:text-left mb-16 md:mb-0 items-center">
                    <p className=" rtl:text-center rtl:md:text-end text-sm  text-sitegreen font-bold mb-5 w-full">{t("À propos de nous")}</p>
                    <div className='rtl:md:ml-auto rtl:md:mb-6 '>
