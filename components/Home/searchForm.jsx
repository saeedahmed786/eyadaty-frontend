                ...
                <div className='sm:px-5 mx-auto'>
                    <form onSubmit={(e) => e.preventDefault()}>
                        <div className="block md:flex justify-around  gap-4 mb-6">
                            ...
                            <div className="w-full md:w-1/4 form-group mb-4 md:mb-0">
                                <Select suffixIcon={<Image src={DownArrow} alt="Down Arrow" />} onChange={handleStateSelection} placeholder={t("Wilaya")} className='w-full'>
                            ...
                            <div className="w-full md:w-1/4 form-group mb-4 md:mb-0">
                                <Select onChange={(val) => setCity(val)} suffixIcon={<Image src={DownArrow} alt="Down Arrow" />} placeholder={t("Commune")} className='w-full'>
                                    {
                                        selectedState &&
                                        (
                        ...
                        <div className="form-group mb-6 ">
                            {
                                !show ?
                                    <button onClick={() => setShow(true)} className='text-siteblue text-[16px] font-[500] flex'> {t("Recherche Avancée")} <span className='px-2'>
                                    ...
                                    :
                                    <div>
                                        <button onClick={() => setShow(false)} className='text-siteblue text-[16px] font-[500] flex'> {t("Recherche Avancée")} <span className='px-2'>
