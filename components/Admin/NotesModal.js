...
const NotesModal = ({ handleUpdate, title, updatedItems }) => {
    ...
    return (
        <>
            <button type='button' onClick={showModal} className='text-[#0094DA] font-[500]'>{t("Ajouter une note")}</button>
                ...
                <div>
                    ...
                    <div className='mt-6'>
                        <div className='text-center'>
                            <button onClick={() => setShow(!show)} className='text-[#0094DA] font-[500]'>{t("Autre note")}</button>
                        </div>
                        {
                            show &&
                            <Input
